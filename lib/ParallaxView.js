...
var ParallaxView = React.createClass({
    ...
    render: function () {
        ...
        var { windowHeight, backgroundSource, blur, contentBackground, centerBackground } = this.props;
            ...
            <View style={[styles.container, style]}>
                {this.renderBackground()}
                {
                    ...
                    style={{
                        ...
                        transform: [{
                          translateY: scrollY.interpolate({
                              inputRange: [ -windowHeight, 0, windowHeight, windowHeight+100],
                              outputRange: [windowHeight/2,0, -windowHeight, -windowHeight]
                          })
                        }],
                  ...
                  <Animated.Image
                    ...
                    style={{
                      transform: [{
                          translateY: scrollY.interpolate({
                              inputRange: [ -windowHeight, 0, windowHeight, windowHeight+100],
                              outputRange: [windowHeight/2,-50, 0, 0]
                          })
                        }]
                    }}
                  />: null
